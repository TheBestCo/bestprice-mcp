...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  /* 8.0.0 is current: 3.0.0 corrected five times (dataset-v4.js … dataset-v8.js).
  ...
  let casesPath = fileURLToPath(new URL('./natural-language-cases.v8.json', import.meta.url));
  let runsPath = fileURLToPath(new URL('./runs.v8.json', import.meta.url));
