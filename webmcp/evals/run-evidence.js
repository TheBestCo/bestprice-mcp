...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  /* 13.0.0 is current: 12.0.0 graded against contract 2.0 (dataset-v13.js); 12.0.0 graded contract
  ...
  let casesPath = fileURLToPath(new URL('./natural-language-cases.v13.json', import.meta.url));
  let runsPath = fileURLToPath(new URL('./runs.v13.json', import.meta.url));
