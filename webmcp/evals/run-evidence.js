...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  /* 16.0.0 is current: 15.0.0 graded against contract 2.6 (dataset-v16.js); 15.0.0 graded contract 2.2
   * (dataset-v15.js); 14.0.0 graded contract 2.1
   * (dataset-v14.js); 13.0.0 contract 2.0 (dataset-v13.js); 12.0.0 contract
  ...
  let casesPath = fileURLToPath(new URL('./natural-language-cases.v16.json', import.meta.url));
  let runsPath = fileURLToPath(new URL('./runs.v16.json', import.meta.url));
