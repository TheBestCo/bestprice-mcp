...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  ...
  /* 15.0.0 is current: 14.0.0 graded against contract 2.2 (dataset-v15.js); 14.0.0 graded contract 2.1
  ...
  let casesPath = fileURLToPath(new URL('./natural-language-cases.v15.json', import.meta.url));
  let runsPath = fileURLToPath(new URL('./runs.v15.json', import.meta.url));
