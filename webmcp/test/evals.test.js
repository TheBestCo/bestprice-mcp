...
describe('evaluation harness and test driver', () => {
  ...
  it('quarantines demo mode and refuses to write into the native evidence store', async () => {
    ...
    for (const target of [
      ...
      { runsFile: fileURLToPath(new URL('../evals/runs.v9.json', import.meta.url)) },
      ...
      { runsFile: fileURLToPath(new URL('../evals/runs.v14.json', import.meta.url)) },
      { runsFile: fileURLToPath(new URL('../evals/runs.v15.json', import.meta.url)) },
      { runsFile: fileURLToPath(new URL('../evals/runs.v16.json', import.meta.url)) },
