...
const definitions = [
  [
    ...
    'Start a product search in this browser tab.',
    NAVIGATION,
    {
      type: 'object',
      properties: {
        query: { type: 'string', minLength: 2, maxLength: 120, description: 'Product or shopping need.' },
      },
      required: ['query'],
  ...
  [
    ...
    'Return up to eight products currently rendered on this listing.',
    READ_ONLY,
    {
      type: 'object',
      properties: {
        limit: { type: 'integer', minimum: 1, maximum: 8, description: 'Maximum products to return.' },
      },
      additionalProperties: false,
    },
  ],
  [
    ...
    'Open a visible product',
    'Open a visible product using an ID returned by get_visible_products.',
    NAVIGATION,
    {
      type: 'object',
      properties: {
  ...
  [
    'get_listing_filters',
    'Available filters',
    'Return selected and available filters currently rendered on this listing.',
    READ_ONLY,
    EMPTY_SCHEMA,
  ],
  [
    ...
    'Apply a filter',
    'Apply a currently visible filter value.',
    NAVIGATION,
    {
      type: 'object',
      properties: {
  ...
  [
    ...
    'Clear filters',
    'Clear the filters currently applied to this listing.',
    NAVIGATION,
    EMPTY_SCHEMA,
  ],
  [
    ...
    'Return sorting choices currently rendered on this listing.',
    READ_ONLY,
    EMPTY_SCHEMA,
  ],
  [
    'apply_listing_sort',
    'Sort this product listing',
    'Apply a currently visible sorting option.',
    NAVIGATION,
    {
      type: 'object',
      properties: {
        sort: { type: 'string', minLength: 1, maxLength: 72, description: 'Visible sorting option.' },
      },
      required: ['sort'],
      additionalProperties: false,
    },
  ...
  [
    'get_page_product',
    'Product details on this page',
    'Return the product facts currently rendered on this item page.',
    READ_ONLY,
    EMPTY_SCHEMA,
  ],
  [
    'compare_page_offers',
    'Compare offers on this page',
    'Compare up to four visible offers by delivered price.',
    READ_ONLY,
    {
      type: 'object',
  ...
  [
    ...
    'Return structured specifications for the product on this page.',
    READ_ONLY,
    {
      type: 'object',
      properties: {
  ...
  [
    ...
    'Summarize the visible product price history.',
    READ_ONLY,
    EMPTY_SCHEMA,
  ],
  [
    'show_price_history',
    'Show this product price history',
    'Open or focus the price-history chart on this page.',
    NAVIGATION,
    EMPTY_SCHEMA,
  ],
];
